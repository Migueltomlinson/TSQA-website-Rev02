...
FAQ_IMPAC = [
    ...
    ("How long does IMPAC PREQUAL take?",
     ["The timeframe depends on how complete your existing health and safety system is. If your documentation and evidence are already in good shape, preparing a submission can be relatively quick, but closing gaps takes longer.",
      "Assessment and turnaround times are set by IMPAC, so check current timeframes directly with the scheme."],
     True),
    ("Does IMPAC PREQUAL need to be renewed?",
     ["Yes, pre-qualification is generally maintained on an ongoing basis rather than being a one-off.",
      "Renewal periods and reassessment requirements are set by IMPAC, so confirm the current cycle with the scheme. TSQA can help you keep your system and evidence current so renewal is straightforward."],
     True),
]
...
FAQ_SITEWISE = [
    ...
    ("How is a SiteWise grade calculated?",
     ["A SiteWise grade reflects an assessment of your health and safety management system against a set of questions covering your policies, processes, and evidence.",
      "The exact scoring bands and pass thresholds are set by Site Safe, so check the current grading criteria with the scheme. TSQA works with you to strengthen the areas that carry weight so you can achieve a strong grade."],
     True),
    ("How long does a SiteWise assessment last?",
     ["A SiteWise grade is valid for a set period before it needs to be renewed through reassessment.",
      "The current validity period is set by Site Safe, so confirm it with the scheme. Keeping your health and safety evidence up to date through the year makes renewal much easier."],
     True),
...
FAQ_SHE = [
    ("What is SHE Pre-Qual?",
     ["SHE Pre-Qual is a health and safety pre-qualification assessment widely used across the building and construction sector.",
      "Many councils and principal organisations require contractors to hold a valid SHE assessment before undertaking high-risk or long-term work. It checks that you have an active safety management system that works in practice, not just on paper."],
     False),
    ...
    ("How long does SHE Pre-Qual take to complete?",
     ["The time it takes depends mostly on how developed your current health and safety system is and how quickly gaps can be closed.",
      "Assessment turnaround is set by the scheme operator, so check current timeframes directly. TSQA helps you prepare a complete submission so avoidable delays are minimised."],
     True),
]
...
FAQ_TOTIKA = [
    ...
    ("How long does Totika certification take?",
     ["The timeframe depends on how ready your existing health and safety system is and which scheme you go through, because Totika recognises assessments from approved pre-qualification schemes.",
      "Processing and recognition times are set by CHASNZ and the approved schemes, so confirm current timeframes with them. TSQA guides you through the process from start to finish to keep it moving."],
     True),
